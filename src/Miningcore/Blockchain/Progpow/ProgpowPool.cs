...
public class ProgpowPool : PoolBase
{
    ...
    {
        return ProgpowUtils.EncodeTarget(difficulty);
    }
    ...
    {
        return ctx.Resolve<ProgpowJobManager>(new TypedParameter(typeof(IExtraNonceProvider), new ProgpowExtraNonceProvider(poolConfig.Id, clusterConfig.InstanceId)));
    }
